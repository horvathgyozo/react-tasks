...
6. Végezd el a feladatot "uncontrolled" módon is! Ehhez a `useRef` hook-ot kell használnod! Az űrlap elküldésekor olvasd ki a beviteli mező értékét a ref segítségével, és add hozzá a playlist-ekhez! Ezután állítsd vissza az űrlapot üresre!
